(function(exports) {
  ...
  var BLOCKS = {
      ...
      .render(function(svg, data) {
        ...
        var y = function(d) { return d.visits; },
            series = timeSeries()
              ...
              .y(y)
              .label(function(d) {
                var datecheck = new Date( d.date );
                datelbl = datecheck.getDay();
                if(datelbl % 7 == 0) {
                  return d.date;
                } else {
                  return "";
                }
                //return d.date;//+formatDate(d.date);
              })
              .title(function(d) {
    ...
    "mobileusers": renderBlock()
      .render(function(selection, data) {
        var totals = data.data[0];
        selection.text(formatPercent(+totals.active_visitors));
      }),
    // sections en block
    "sections-en": renderBlock()
    ...
    // departments fr block
    "departments-fr": renderBlock()
      .transform(function(d) {
        return d.data;
      })
      .on("render", function(selection, data) {
    ...
    "visitor-location-city": renderBlock()
      .transform(function(d) {
        return d.data;
      })
      .on("render", function(selection, data) {
    ...
    "visitor-location-region": renderBlock()
      .transform(function(d) {
        return d.data;
      })
      .on("render", function(selection, data) {
      ...
      .render(barChart()
        .label(function(d) { return d.region; })
        .value(function(d) { return +d.active_visitors; })
        .scale(function(values) {
          var max = d3.max(values);
          return d3.scale.linear()
        ...
        .format(formatPercent)),
    "visitor-location-country": renderBlock()
      .transform(function(d) {
        return d.data;
      })
      .on("render", function(selection, data) {
